    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Connectez-vous pour gérer votre infrastructure IoT</p>
        </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800 font-semibold mb-2">🔑 Identifiants de test :</p>
          <p className="text-sm text-blue-700">
            <strong>Email :</strong> admin@example.com<br />
            <strong>Mot de passe :</strong> password123
          </p>
          <p className="text-xs text-blue-600 mt-2">
            (Créez d'abord un utilisateur avec ces identifiants via MongoDB ou un script seed)
          </p>
        </div>
      </div>
    </div>
